...
#if (CL_HPP_TARGET_OPENCL_VERSION >= 120 && CL_HPP_MINIMUM_OPENCL_VERSION < 120) || (CL_HPP_TARGET_OPENCL_VERSION >= 200 && CL_HPP_MINIMUM_OPENCL_VERSION < 200)
...
public:
     ...
     */
    template <typename T>
    typename std::enable_if<std::is_same<T, cl_float4>::value || std::is_same<T, cl_int4>::value || std::is_same<T, cl_uint4>::value,
        cl_int>::type
    enqueueFillImage(
        const Image& image,
        T fillColor,
     ...
     */
    template <typename T>
    typename std::enable_if<std::is_same<T, cl_float4>::value || std::is_same<T, cl_int4>::value || std::is_same<T, cl_uint4>::value, cl_int>::type
    enqueueFillImage(
        const Image& image,
        T fillColor,
        const array<size_type, 2>& origin,
...
#endif
        if ((pfn_clCreateSemaphoreWithPropertiesKHR == nullptr) && (pfn_clReleaseSemaphoreKHR == nullptr) && (pfn_clRetainSemaphoreKHR == nullptr) && (pfn_clEnqueueWaitSemaphoresKHR == nullptr) && (pfn_clEnqueueSignalSemaphoresKHR == nullptr) &&
#ifdef cl_khr_external_semaphore
