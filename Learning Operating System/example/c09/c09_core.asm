...
%include "..\common\core_utils64_mp.wid"          ;引入内核用到的例程
...
create_thread:                                    ;创建一个线程
         ...
         mov qword [rbx + 240], SUGG_PREEM_SLICE  ;推荐的线程执行时间片，来自global_defs.wid
...
create_process:                                   ;创建新的任务及其主线程
  ...
  .rdok:
         ...
         mov qword [r12 + 240], SUGG_PREEM_SLICE  ;推荐的线程执行时间片，来自global_defs.wid
