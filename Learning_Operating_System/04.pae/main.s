...
.equ PDPT_PHY_ADDR, 0x00009000 # 对应于页目录指针表物理地址
.equ PMD_PHY_ADDR, 0x0000a000 # 对应于页目录表物理地址
.equ PT_PHY_ADDR, 0x0000b000 # 对应于低端2MB的内核页表的物理地址
...
.code32
    ...
    movl $PMD_PHY_ADDR | 0x01, %eax
    movl %eax, (%ebx)
    movl %edx, 0x04(%ebx)

    movl $PMD_PHY_ADDR, %ebx
