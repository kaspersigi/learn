...
rm -rf $ADB_PATH
unzip $TEMP_PATH/platform-tools-r35.0.2-windows.zip -d $USER_PATH/Downloads
rm -rf $TEMP_PATH/platform-tools-r35.0.2-windows.zip
...
# git clone --single-branch -b v1.10.0 --depth 1 git@github.com:raspberrypi/rpicam-apps.git
# git clone --single-branch -b v1.10.0 --depth 1 https://github.com/raspberrypi/rpicam-apps.git
# git clone --single-branch -b v0.5.2+rpt20250903 --depth 1 git@github.com:raspberrypi/libcamera.git
# git clone --single-branch -b v0.5.2+rpt20250903 --depth 1 https://github.com/raspberrypi/libcamera.git
