...
void MainWorker::execute()
{
    pthread_t mw_tid = 0;
    pthread_t cw_tid = 0;
    [[maybe_unused]] int mw_ret = pthread_create(&mw_tid, NULL, &MainWorker::main_worker, NULL);
    [[maybe_unused]] int cw_ret = pthread_create(&cw_tid, NULL, &ChildWorker::child_worker, NULL);
