...
public:
    ...
    static int ftrace_async_begin(const std::string& id, const std::string& message);
    static int ftrace_async_instant(const std::string& id, const std::string& message);
    static int ftrace_async_end(const std::string& id);

    // Flow Events (s/t/f)
    static int ftrace_flow_start(const std::string& flow_id, const std::string& message);
    static int ftrace_flow_step(const std::string& flow_id, const std::string& message);
    static int ftrace_flow_end(const std::string& flow_id);
